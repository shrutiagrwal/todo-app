...
function showtask() {
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    <td><button type="button"onclick="complete(${index})" class="text-success" id=${index}><i class="fa fa-check-square-o"></i>Complete</button></td>
...
function complete(index) {
    let webtask = localStorage.getItem("localtask");
    taskObj = JSON.parse(webtask);
    let val = taskObj[index].completeStatus
    if (val === false) {
